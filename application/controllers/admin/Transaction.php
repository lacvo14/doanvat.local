...
Class Transaction extends MY_Controller {
    ...
    function index() {
        ...
        $config = array();
        $config['total_rows'] = $total; //tong tat ca cac giao dich tren website
    ...
    function active() {
        ...
        //lay thong tin cua giao dịch
        $info = $this->transaction_model->get_info($id);
        $order_input['where'] = array('transaction_id' => $id);
        $order = $this->order_model->get_list($order_input);
    ...
    function cancel() {
        ...
        //gui thong bao
        $this->session->set_flashdata('message', 'Đã hủy đơn hàng này');
        redirect(admin_url('transaction'));
    }
