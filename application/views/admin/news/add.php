    ...
    <div class="x_panel">
        <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
                <li><a href="<?php echo admin_url('') ?>news" class="btn btn-primary"><i class="fa fa-list"></i> Danh sách </a></li>
            </ul>
            ...
            <form class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        <input value="<?php echo set_value('name') ?>" type="text" name="name" class="form-control" data-original-title="Tên bài viết" placeholder="Tên bài viết" data-toggle="tooltip" data-placement="top" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        <textarea class="ckeditor" name="content" class="form-control" data-original-title="" data-toggle="tooltip" data-placement="top"><?php echo set_value('content') ?></textarea> 
                        <ul class="parsley-errors-list filled" id="parsley-id-7">
...
<!--                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        <input id="link_file" readonly="" name="link_file" type="text" onclick="BrowseServer()" value=""/> 
                        <input id="btn" type="button" onclick="BrowseServer()" value="Browse"/> 
                    </div>
                </div>         
                ...
                <div class="form-group">
                    <div class="col-md-3 col-sm-3 col-xs-3 col-md-offset-1">
                        <button type="submit" class="btn btn-success"><span class="fa fa-check"></span> Thêm bài đăng mới </button>
                    </div>
                </div>
            </form>
            <br />
