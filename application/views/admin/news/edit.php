            ...
            <form class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        <input value="<?php echo $news->name ?>" type="text" name="name" class="form-control" data-original-title="Tên bài viết" placeholder="Tên bài viết" data-toggle="tooltip" data-placement="top" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        <select name="cat_id" data-original-title="Chọn Chuyên mục" data-toggle="tooltip" data-placement="top">
                            ...
                            <option value="<?php echo  $row->id?>" <?php echo ($row->id == $news->cat_id) ? 'selected' : '' ?> style="padding:3px 0 3px 10px; border-top:1px solid; font-weight:600">
                                <?php echo  $row->name ?>
                            </option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        <textarea class="ckeditor" name="content" class="form-control" data-original-title="" data-toggle="tooltip" data-placement="top"><?php echo $news->content ?></textarea> 
                        <ul class="parsley-errors-list filled" id="parsley-id-7">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5 col-sm-10 col-xs-10">
                        ...
                        <img src="<?php echo base_url('') ?>upload/news/thumb/<?php echo $news->image_link ?>" height="50">
                    </div>
                </div>
