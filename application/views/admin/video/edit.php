            ...
            <form class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        <input value="<?php echo $info->title ?>" type="text" name="title" class="form-control" data-original-title="Tiêu đề" placeholder="Tiêu đề" data-toggle="tooltip" data-placement="top" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        <input value="<?php echo $info->link ?>" type="text" name="link" class="form-control" data-original-title="Link" placeholder="VD : https://www.youtube.com/watch?v=gdBZLueegq8 " data-toggle="tooltip" data-placement="top" />
                        <ul class="parsley-errors-list filled" id="parsley-id-7">
