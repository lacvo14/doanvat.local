            ...
            <form class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        <input value="<?php echo $info->name ?>" type="text" name="name" class="form-control" data-original-title="Tên sản phẩm" placeholder="Tên sản phẩm" data-toggle="tooltip" data-placement="top" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        <select name="catalog_id" data-original-title="Chọn Chuyên mục" data-toggle="tooltip" data-placement="top">
                            ...
                            <option value="<?php echo  $row->id?>" <?php echo ($row->id == $info->catalog_id) ? 'selected' : '' ?> style="padding:3px 0 3px 10px; border-top:1px solid; font-weight:600">
                                <?php echo  $row->name ?>
                            </option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        <textarea rows="7" name="price" placeholder="Nhập giá sản phẩm, 1 dòng 1 loại giá" class="form-control"><?php echo implode("\r\n", json_decode($info->price)); ?></textarea> 
                        <ul class="parsley-errors-list filled" id="parsley-id-7">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        <label class="checkbox-inlinge"><input name="feature" <?php if ($info->feature == 1) echo 'checked'?> type="checkbox" value="1" ></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-5 col-sm-10 col-xs-10">
                        ...
                        <img src="<?php echo base_url('') ?>upload/product/thumb/<?php echo $info->image_link ?>" height="50">
                    </div>
                </div>
