<div class="col-md-12 col-sm-12 col-xs-12 wrap-box">
    <div class="x_panel">
        <div class="x_title">
            <h2>Chỉnh sửa Chuyên Mục Feedback</h2>
            <ul class="nav navbar-right panel_toolbox">
                <li><a href="<?php echo admin_url('') ?>comments_cat" class="btn btn-primary"><i class="fa fa-list"></i> Danh sách </a></li>
            </ul>
            ...
            <form id="form" class="form-horizontal form-label-left" method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="username" name="name" class="form-control col-md-7 col-xs-12" value="<?php echo $comments->name ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="number" id="sort_order" name="sort_order" class="form-control col-md-7 col-xs-12" value="<?php echo $comments->sort_order ?>">
                        <ul class="parsley-errors-list filled" id="parsley-id-7">
