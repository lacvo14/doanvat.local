...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            <a href="<?php echo admin_url('') ?>comments/add" class="btn btn-info"><i class="fa fa-plus-square-o"></i> Thêm mới </a>
            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                        ...
                        <tbody>
                            <?php foreach ($list as $row): ?>
                                <tr class="row_<?php echo $row->id ?>">
                                    ...
                                    <td class=" "><img src="<?php echo base_url('') ?>upload/comments/thumb/<?php echo $row->image_link ?>" height="50"></td>
                                    <td class=" "><?php echo $row->name ?> </td>
                                    <td class=" "><?php echo $row->cat_id ?> </td>
                                    <td class=" "><?php echo $row->slug ?> </td>
                                    <td class=" ">
                                        <a href="<?php echo base_url('camnhan/' . $row->slug . '-' . $row->id . '.html') ?>" target="_blank" class="btn btn-success btn-xs" title="Xem"><i class="fa fa-eye"></i> Xem </a>
                    ...
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">
                        <button class="btn btn-danger" id="delete_all" url="<?php echo admin_url('comments/delete_all') ?>"  ><i class="fa fa-trash" aria-hidden="true"></i> Xóa mục đã chọn </button>
                    </label>
