                ...
                <div class="col-md-12">
                    <div class="breadcrumb-list">
                        <ul class="breadcrumb">
                            ...
                            <li><?php echo $product_cat->name ?></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="product-menu">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="<?php echo base_url('san-pham/' . $product_cat->slug) ?>"><?php echo $product_cat->name ?></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="product-per-page">
                                        <p>Total : <span><?php echo $total ?></span> products</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
